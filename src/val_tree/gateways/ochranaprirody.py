...
HABITAT_CODE = {
    'dutinky (A)'                           : 'a',
    'dutiny (A)'                            : 'b',
    'hmyzí galerie a otvory (A)'            : 'c',
    'kmenové dutiny (A/R)'                  : 'd',
    'odlupující/odchylující se borka (A)'   : 'e',
    'pahýly po větvích (A)'                 : 'f',
    'plodnice hub (A)'                      : 'g',
    'poškození borky (A)'                   : 'h',
    ...
    'vodní kapsy (A)'                       : 'l',
    'výtok mízy (A)'                        : 'm',
    'zduřelé, členité kořenové náběhy (A)'  : 'n',
}
